...
token scan() {
    ...
    if (isalpha(c)) {
        ...
        case '<':
            c = getchar();
            if(c == '>'){c = getchar (); return t_not_eq;} 
            else if(c == '=') {c = getchar (); return t_less_eq;}
            else{ c = getchar (); return t_less; }
            break;
        case '>':
            c = getchar();
            if(c == '=') {c = getchar (); return t_great_eq; }
            else{ c = getchar(); return t_great; }
            break;
